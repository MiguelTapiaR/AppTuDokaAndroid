...
public class AgregarActividadCapacitacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(AgregarActividadCapacitacionActivity.this,
                Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {

            // Permission is not granted
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(AgregarActividadCapacitacionActivity.this,
                    Manifest.permission.READ_EXTERNAL_STORAGE)) {
                ActivityCompat.requestPermissions(AgregarActividadCapacitacionActivity.this,
        ...
        fotoItemBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                easy_image.openChooser(AgregarActividadCapacitacionActivity.this);
            }
        });
        ...
        continuarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (descripcion.getText().toString() != ""){
                    ...
                    Intent intent = new Intent(getApplicationContext(), ResumenActividadesCapacitacionActivity.class);
