...
public class DatosDevolucionActivity extends AppCompatActivity implements IfFirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchableSpinnerNomCliente.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                reporteDevolucion.setCliente(alCliente.get(i));
        ...
        searchableSpinnerNomProyecto.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                reporteDevolucion.setProyecto(alProyectos.get(i));
